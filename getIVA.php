...
$codigo = $_POST['codigo'];
$mquery = "SELECT valor FROM concepto where empresa='0001' and clave='IVA'";
$result = mysql_query($mquery);
$num = mysql_result($result,$i,"valor");
$Json_Array = array("IVA" => $num);
...
<form action="getIVA.php" method="post">
