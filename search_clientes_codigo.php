...
$codigo = $_POST['codigo'];
$query = "SELECT nombre,direccion,clave,nivel,descuento,telefono1,telefono2 FROM clientes where clave='{$codigo}'";
...
<form action="search_clientes_codigo.php" method="post">
